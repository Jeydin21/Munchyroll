      ...
      <div className="px-4 flex flex-col gap-2">
        {filteredEpisodes.map((episode, i) => (
          <Link
            ...
            className={`transition-all duration-150 text-primary dark:text-secondary w-full flex items-center gap-2 rounded-md ${episode.id === episodeName ? 'bg-blue-500 text-secondary' : 'bg-secondary-light dark:bg-primary-hover hover:bg-secondary-hover dark:hover:bg-primary-light'}`}
